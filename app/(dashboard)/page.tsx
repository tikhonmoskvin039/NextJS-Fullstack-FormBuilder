...
import { RemoveFormButton } from '@/components/custom/RemoveFormButton';
...
const FormCard = ({ form }: { form: Form }) => {
  return (
    <Card>
      ...
      <CardContent className="h-[20px] flex justify-between truncate text-sm text-muted-foreground">
        <p>{form.description || 'No description'}</p>
        <RemoveFormButton form={form} />
      </CardContent>
      <CardFooter>
        {form.published && (
          <Button
